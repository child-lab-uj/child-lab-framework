...
type Array = NDArray[numpy.floating[Any]]

type Corners = Float[Array, 'n 1 2']
type Corner = Float[Array, '2']
...
class BoardProperties:
    ...
    @property
    def rigid_model(self) -> Float[Array, 'n 4']:
        """
...
class AggregatedDetectionProperties:
    ...
    __PROGRESS_WEIGHTS: ClassVar[Float[Array, 'n 5']] = numpy.array(
        (
            __AREA_WEIGHT,
            __SKEW_WEIGHT,
            __X_OFFSET_WEIGHT,
    ...
    def mean(self) -> 'DetectionProperties':
        ...
        return DetectionProperties(*numpy.mean(self.__data, axis=0).flatten().tolist())
    ...
    def progress(self) -> 'DetectionProperties':
        ...
        value_range: Float[Array, '5'] = max - min
...
class Result:
    ...
    def visualize(
        self,
        frame: ArrayRgbFrame,
        configuration: VisualizationParameters,
    ) -> ArrayRgbFrame:
        """
