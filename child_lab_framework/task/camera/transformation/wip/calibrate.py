...
def calibrate_camera(video_path: str, frame_skip: int) -> Camera:
    ...
    for frame in nth_frame(video_path, frame_skip):
        ...
        if found:
            ...
            refined_corners = cv2.cornerSubPix(gray_frame, corners, (11, 11), (-1, -1), termination_criteria)
    ...
    return Camera(camera_matrix, distortion_coefficients, rotation_vectors, translation_vectors)
