...
class TransformBuffer:
    ...
    def add_transform(self, input_frame: str, output_frame: str, rotation_matrix: np.ndarray, translation_vector: np.ndarray):
    ...
    def transform(
        self, input_frame: str, output_frame: str, point: np.ndarray
    ):
        rotation_matrix, translation_vector = self.get_transform(input_frame, output_frame)
