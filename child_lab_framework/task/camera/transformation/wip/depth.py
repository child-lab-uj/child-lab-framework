...
class Metric3D:
    ...
    def prepare_input(self, image_rgb: np.ndarray)->Tuple[torch.Tensor, List[int]]:
        ...
        self.scale = scale
        rgb = cv2.resize(image_rgb, (int(w * scale), int(h * scale)), interpolation=cv2.INTER_LINEAR)
...
if __name__ == "__main__":
    camera_matrix = np.array(
        [[524.86812468,   0.,         524.92448944],
        [  0.,         352.13927069, 707.66841893],
        [  0.,           0.,           1.        ]]
    )
    ...
    img = cv2.imread("/Users/igor/Work/child-lab/depth_estimation/Metric3D/images/janek.webp")
